...
public interface SysNoticeReadMapper
{
    ...
    /**
     * 分页查询已阅读某公告的用户列表（IPage 首参，复用同 XML 条件）
     */
    IPage<Map<String, Object>> selectReadUsersPage(IPage<Map<String, Object>> page, @Param("noticeId") Long noticeId, @Param("searchValue") String searchValue);
